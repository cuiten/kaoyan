    	...
    	_menus = {
   	         "menus": [
      	           ...
      	           <%-- {"menuid": "56", "icon": "icon-role", "menuname": "成绩列表",
   	                ...
   	                {"menuid": "56", "icon": "icon-role", "menuname": "课程分类管理",
   	                 "menus": [
   	                     {"menuid": "31", "menuname": "课程分类列表", "icon": "icon-users", "url": "<%= __APP__%>/Good!type"}
   	                 ]
   	
   	             },
   	          {"menuid": "56", "icon": "icon-role", "menuname": "课程资料管理",
   	                 "menus": [
   	                     {"menuid": "31", "menuname": "课程资料列表", "icon": "icon-users", "url": "<%= __APP__%>/Good!good"}
   	                 ]
   	
   	             },
   	          <%-- {"menuid": "56", "icon": "icon-role", "menuname": "作业管理",
   	                 "menus": [
   	                     {"menuid": "31", "menuname": "作业列表", "icon": "icon-users", "url": "<%= __APP__%>/Shijuan!shijuan"}
   	                 ]
