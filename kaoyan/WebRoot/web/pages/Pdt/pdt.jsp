    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '答案', width: 100, field: 'daan', sortable: true}
            ]
        ], toolbar: [
            {
                text: '新增',
...
function deleteItem(uuid) {
    openBackGround();
    $.post("<%=__APP__%>/Pdt!deleteItem", {id: uuid}, function (data) {
        closeBackGround();
        closeFlush();
    });
}
...
<div id="managerDialog" class="easyui-dialog" title="判断题管理" style="width:450px;height:350px;" toolbar="#dlg-toolbar"
    ...
    <form id="managForm" name="managForm" method="post" enctype="multipart/form-data">
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            ...
            <tr>
                <th width="30%" align="right"><label>答案：</label></th>
                <td colspan="1" width="60%">
                    <select id="daan" name="pdt.daan">
                    	<option value="1" selected="selected">对</option>
            ...
            <th width="30%" align="right"><label>分类：</label></th>
                <td width="30%">                   	
                    <select id="typeid" name="pdt.typeid" style="width:200px;word-wrap: break-word;word-break:break-all;" >
