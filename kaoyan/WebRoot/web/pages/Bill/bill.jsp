    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '预约编号', width: 50, field: 'id', sortable: true},
                {title: '名称', width: 300, field: 'gnames', sortable: true},
                //{title: '预约方式', width: 100, field: 'way', sortable: true},
           ...
           /*  {
            ...
            '-',*/
            {
                ...
                handler: function () {
                    ...
                    if (selected) {
                        $.post("<%=__APP__%>/Bill!jiaohao",{bid:selected.id,statecn:"通过"},function(){
                        	closeFlush();
                        });
                    } else {
            ...
            '-',{
                ...
                handler: function () {
                    ...
                    var selected = $('#grid1').datagrid('getSelected');
                    if (selected) {
                        $.post("<%=__APP__%>/Bill!jiaohao",{bid:selected.id,statecn:"未通过"},function(){
                        	closeFlush();
                        });
                    } else {
                        $.messager.alert("提示", "请选择一条记录进行操作");
