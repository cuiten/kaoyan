...
<div id="managerDialog" class="easyui-dialog" title="课程资料管理" style="width:650px;height:350px;" toolbar="#dlg-toolbar"
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
          ...
          <%--  <tr>
           ...
           <!--  <th width="30%" align="right"><label>分类：</label></th> -->
                ...
                <th width="30%" align="right"><label>文件：</label></th>
                <td width="30%" colspan="">
                   <input type="file" name="attach" id="attach" style="width:200px;word-wrap: break-word;word-break:break-all;"/>
                </td>
